...
export default function Dashboard() {
  ...
  async function handleAIChat(message) {
    ...
    try {
      const lastScanMessage = [...messages]
        .reverse()
        .find((item) => item.type === "scan-result");

      const scanResult = lastScanMessage?.result || null;

      console.log("Sending AI request to:", `${API_BASE}/api/ai/chat`);
